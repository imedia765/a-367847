  ...
  return (
    <div className="bg-dashboard-card rounded-lg shadow-lg p-8 mb-12">
      ...
      <div className="text-dashboard-text space-y-4">
        ...
        <p className="font-bold text-[#FEF7CD]">Check with your collector if payments up to date, if not up to date YOU ARE NOT COVERED! The responsibility to pay is on the member, not the Collector.</p>
